...
router.get('/',checkLoginUser, function(req, res, next) {
  ...
  router.post('/',checkLoginUser, function(req, res, next) {
    ...
    var password_details = new passModel( {
      ...
      projet_names:project_name,
      password_detail:pass_details 
    } );
    password_details.save(function(err,doc){
      getPassCat.exec(function(err,data){
      if(err) throw err;
      res.render('addNewPassword', { title: 'Password Management System',loginUser:loginUser,records:data,success:'Passwsord Detail Inserted Successfully' });
    });
  });
