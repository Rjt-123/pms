...
var PassDetailRouter = require('./routes/password-detail');
var PassCatRouter = require('./routes/passwordCategory');
...
app.use('/password-detail',PassDetailRouter );
app.use('/passwordCategory',PassCatRouter );
